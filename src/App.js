...
import './App.css';
import { MovieLiest } from './MovieLiest';
...
function App(){
  const navigate=useNavigate();
   ...
   <Routes>
        ...
        <Route path="/movies" element={<MovieLiest movieList={movieList} setMovieList={setMovieList} />} />
        <Route path="/color-game" element={<Addcolor />} />
        <Route path="//movie-add" element={<AddMovie movieList={movieList} setMovieList={setMovieList}  />} />
        <Route path="/movie/edit/:id" element={<EditMovie />} />
        <Route path="/movie/:id" element={<MovieDetial movieList={movieList} setMovieList={setMovieList}  />} />
